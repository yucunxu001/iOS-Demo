...
/**
 ...
 @return 返回操作结果
 */
- (BOOL)recordAudioStart:(NSString *)file;

/**
 @author Lion, 18-12-08 11:01:21
...
/**
 ...
 @return 返回操作结果
 */
- (BOOL)recordVideoStart:(NSString *)file withiDirect:(int)iDirect;
