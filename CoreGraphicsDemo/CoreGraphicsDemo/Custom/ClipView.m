...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextClipToRect(context, CGRectMake(50, 50, rect.size.width - 50 * 2, rect.size.height - 50 * 2));
    CGContextAddEllipseInRect(context, CGRectMake(0, 0, rect.size.width, rect.size.height));
    CGContextAddEllipseInRect(context, CGRectMake(60, 60, rect.size.width - 60 * 2, rect.size.height - 60 * 2));
